...
const GUIDANCE_LEVELS: { value: GuidanceLevel; label: string; description: string }[] = [
...
const RECOVERY_PROFILES: { value: RecoveryProfile; label: string; description: string }[] = [
