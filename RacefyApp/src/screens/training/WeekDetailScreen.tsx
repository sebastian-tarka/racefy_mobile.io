...
export function WeekDetailScreen({ navigation, route }: Props) {
  ...
  const handleSkipWeek = async () => {
    Alert.alert(t('training.weekDetail.confirmSkip'), t('training.weekDetail.confirmSkipMessage'), [
      { text: t('common.cancel'), style: 'cancel' },
      {
        text: t('common.confirm'),
        style: 'destructive',
    ...
    <ScreenContainer>
      ...
      >
        ...
        <Card style={styles.weekInfoCard}>
          <Text style={[styles.weekInfoPhase, { color: colors.primary }]}>{week.phase_name}</Text>
            ...
            <Card key={activity.id} style={styles.sessionCard}>
              <View style={styles.sessionHeader}>
                <View style={styles.sessionTitleContainer}>
                  <View
                    style={[styles.sessionNumberBadge, { backgroundColor: colors.primary + '15' }]}
                  >
