...
const USER_CACHE_KEYS = ['@racefy_home_data', '@racefy_home_config'];
 ...
 */
export function useImpersonationActions(state: ImpersonationState, setters: ImpersonationSetters) {
  ...
  const restoreAdminToken = useCallback(
