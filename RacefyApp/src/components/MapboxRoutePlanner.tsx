...
export const MapboxRoutePlanner = forwardRef<MapboxRoutePlannerHandle, MapboxRoutePlannerProps>(
  function MapboxRoutePlanner(
    {
      waypoints,
      routeGeometry,
      isLoadingPreview,
              ...
              <MapboxGL.CircleLayer
                ...
                style={{
                  ...
                  circleColor: [
                    ...
                    startColor,
                    ['get', 'isLast'],
                    waypoints.length > 1 ? endColor : startColor,
                    waypointColor,
                  ],
                  circleStrokeWidth: 3,
